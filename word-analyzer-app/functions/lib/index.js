...
exports.generateAssessmentPdf = exports.generateAssessmentVideo = exports.processAssessment = exports.preTranscribeAudio = void 0;
 ...
 */
exports.preTranscribeAudio = functions
    .runWith({
    timeoutSeconds: 180,
    memory: '512MB',
})
    ...
    const data = doc.data();
    if ((data === null || data === void 0 ? void 0 : data.preTranscript) || (data === null || data === void 0 ? void 0 : data.status) === 'processing' || (data === null || data === void 0 ? void 0 : data.status) === 'complete') {
...
exports.processAssessment = functions
    ...
    try {
        ...
        const hasPreTranscript = (assessmentData === null || assessmentData === void 0 ? void 0 : assessmentData.preTranscribeStatus) === 'complete' &&
            (assessmentData === null || assessmentData === void 0 ? void 0 : assessmentData.preTranscriptWords);
        ...
        if (hasPreTranscript) {
            ...
            transcription = await (0, speechToText_1.transcribeAudio)(gcsUri, audioContentType);
        }
        ...
        const patternSummary = (0, metricsCalculator_1.generatePatternSummary)(errorPatterns, metrics);
