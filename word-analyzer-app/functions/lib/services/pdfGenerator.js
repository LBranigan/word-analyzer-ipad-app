...
async function generatePdfReport(input) {
    return new Promise((resolve, reject) => {
        ...
        doc.text(`Date: ${input.assessmentDate.toLocaleDateString('en-US', {
            weekday: 'long',
            year: 'numeric',
            month: 'long',
            day: 'numeric',
        ...
        doc
            ...
            .font('Helvetica')
            .fillColor('#333333')
            .text(`${input.studentName} read ${input.metrics.totalWords} words at ${input.metrics.wordsPerMinute} words per minute with ${input.metrics.accuracy}% accuracy.`, 70, boxY + 45, { width: 455 });
        ...
        doc
            ...
            .font('Helvetica')
            .fillColor('#999999')
            .text('Generated by Word Analyzer', 50, doc.page.height - 40, { align: 'center', width: 495 });
        doc.end();
    });
}
