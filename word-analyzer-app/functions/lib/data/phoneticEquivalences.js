...
exports.phoneticEquivalences = void 0;
exports.arePhoneticEquivalents = arePhoneticEquivalents;
/**
...
function arePhoneticEquivalents(word1, word2) {
    ...
    if (w1 === w2)
        return true;
    const equivalents1 = exports.phoneticEquivalences[w1] || [];
    const equivalents2 = exports.phoneticEquivalences[w2] || [];
    return equivalents1.includes(w2) || equivalents2.includes(w1);
}
//# sourceMappingURL=phoneticEquivalences.js.map